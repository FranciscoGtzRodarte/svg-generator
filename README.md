...
![Image showing a green circle with white text that reads "SVG.".](./Assets/img/mockup.png)
...
Then you will be presented with four user input for text of your logo, color of the text, a list of shapes to choose and a shape color.
...
If everything is input correctly a new svg will be generated with those values in the directory ./examples.
...
[Watch video](https://www.loom.com/share/3922f98d2d464f8783d7be71895179e9)
